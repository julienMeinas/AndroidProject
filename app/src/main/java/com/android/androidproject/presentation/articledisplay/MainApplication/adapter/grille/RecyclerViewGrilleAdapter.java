package com.android.androidproject.presentation.articledisplay.MainApplication.adapter.grille;
...
public class RecyclerViewGrilleAdapter extends RecyclerView.Adapter<RecyclerViewGrilleAdapter.ViewHoler > {
    ...
    public RecyclerViewGrilleAdapter(ArticleActionInterface articleActionInterface) {
    ...
    public ViewHoler onCreateViewHolder(ViewGroup parent,
        ...
        ViewHoler articleViewHolder = new RecyclerViewGrilleAdapter.ViewHoler(v, m_articleActionInterface);
        return articleViewHolder;
    }

    // Replace the contents of a view (invoked by the layout manager)
    @Override
    public void onBindViewHolder(RecyclerViewGrilleAdapter.ViewHoler holder, int position) {
